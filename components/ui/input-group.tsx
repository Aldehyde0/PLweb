...
function InputGroupAddon({
  ...
  VariantProps<typeof inputGroupAddonVariants> & { controlId?: string }) {
  // A <label> is the correct semantics here: clicking any non-button part of the
  // addon focuses the associated control through the browser, with no click
  // handler and no keyboard gap. Point it at the control's id when the caller
  // knows it, otherwise wrap the control or pass controlId explicitly.
  const generatedId = React.useId();
  return (
    <label
      data-slot="input-group-addon"
      data-align={align}
      htmlFor={props.htmlFor ?? controlId ?? generatedId}
