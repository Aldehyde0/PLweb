...
export function ConceptCard({ concept }: { concept: Concept }) {
  ...
  return <Link href={`/concept/${concept.slug}`} className="concept-card group flex min-h-44 flex-col rounded-2xl border border-border bg-card p-5 outline-none transition-colors hover:border-primary/35 hover:bg-accent/30 focus-visible:ring-2 focus-visible:ring-ring">
